...
const RetailRuleEngine_1 = require("../src/retail/RetailRuleEngine");
// ── Snapshot factory ──────────────────────────────────────────────────────────
...
const engine = new RetailRuleEngine_1.RetailRuleEngine();
// ─────────────────────────────────────────────────────────────────────────────
...
describe('RetailRuleEngine – Internationalisation Flexibility', () => {
    ...
    it('penalises each missing legal document', () => {
        ...
        const result = engine.evaluate(snapshot);
        const dim = result.breakdown.internationalizationFlexibility;
        expect(dim.score).toBeLessThan(80); // at least 2 × 10 lost
...
//# sourceMappingURL=RetailRuleEngine.test.js.map